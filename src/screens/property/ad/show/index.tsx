...
import { AntdProvider, LoaderLayout, UserCard } from "@components";
        ...
        <AntdProvider>
          <div className={styles.page}>
            <div className={styles.page_box}>
              {card.image ? (
                <div
                  className={styles.page_box_image}
                ...
                >
                  <PictureOutlined
                    style={{ fontSize: 100, color: "#888b97" }}
                  />
                </div>
              )}
            ...
            <div className={styles.page_info}>
              ...
              <div className={styles.page_info_container}>
                ...
                <div className={styles.user}>
                  <UserCard isClick isCube isRate size={70} user={card.user} />
                </div>
                {isYour && (
